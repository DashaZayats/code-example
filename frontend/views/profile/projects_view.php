                                                ...
                                                <td>
                                                    ...
                                                    <div class="message-img">
                                                        <?php if(Yii::$app->user->identity->imageFile!=''):?>
                                                            <img src="/img/<?php echo Yii::$app->user->identity->imageFile?>"title="<?php echo Yii::$app->user->identity->username." ".Yii::$app->user->identity->email?>" data-toggle="tooltip" data-placement="top">
                                                        <?php else:?>
                                                            <img src="/img/avatar.png" title="<?php echo Yii::$app->user->identity->username." ".Yii::$app->user->identity->email?>" data-toggle="tooltip" data-placement="top">
                                                        <?php endif;?>
                                                    </div>
                                                    <?php endif;?>
                                                </td>
