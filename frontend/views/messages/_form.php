...
<div class="messages-form">
    ...
    <?php $form = ActiveForm::begin(['action' => Yii::$app->urlManager->createUrl(['/messages/create'])]);?>
    ...
    <?= $form->field($model, 'to_user_id')->hiddenInput(['value'=>$response['user_id']])->label(false); ?>
